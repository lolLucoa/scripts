...
local function SearchIcon(ButtonOrNot)
	...
	NewSearchIcon.Position = UDim2.new(1,-18,0,2)
...
function UILibrary.Load(GUITitle, ShowShadow)
	...
	function TabLibrary.AddPage(PageTitle, SearchBarIncluded)
		...
		if SearchBarIncluded then
			...
			SearchBox.Position = UDim2.new(0,2,0,0)
		...
		function PageLibrary.AddSlider(Text, ConfigurationDictionary, Callback, Parent)
			...
			local Default = Configuration.Default or Configuration.default or Configuration.Def or Configuration.def or Minimum
